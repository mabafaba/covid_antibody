...
ab %>% 
  antibody_rectangles(rectangle_color = ipc_colors,
                      ...
                      y=c(-0.1,0.9),lty = "blank") # the track goes from 0 to 1; I move this down a notch so that the clonality peaks out and so there is no gap to the links because it looks cool
